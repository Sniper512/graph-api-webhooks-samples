 ...
 */
function findSimilarQuestions(newQuestion, candidateQuestions, threshold = 0.65) {
    ...
    for (const candidate of candidateQuestions) {
        ...
        const similarity = stringSimilarity.compareTwoStrings(normalizedNew, normalizedCandidate);
